      ...
      <section className='dark:bg-darkmode pt-8 md:pb-24 pb-16'>
        <div className='container mx-auto max-w-6xl px-4'>
          <div className='flex md:flex-row flex-col md:items-center items-start justify-center md:gap-28 gap-8'>
            <div className='flex sm:flex-row flex-col items-start sm:gap-8 gap-4 shadow shadow-gray-300 p-5 rounded-xl'>
              ...
              <div className='flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between '>
                ...
                <div>
                  <Link
                    href={`mailto:${settings?.contactDetails?.email || "info@paarshelearning.com"}`}
            ...
            <div className='flex sm:flex-row flex-col items-start sm:gap-8 gap-4 shadow shadow-gray-300 p-5 rounded-xl'>
              ...
              <div className='flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between'>
                <div>
                  ...
                  <p className='text-DeepOcean font-normal text-lg max-w-80 pt-3 pb-7 dark:text-white/50'>
                    {settings?.contactDetails?.phone || "+91 90752 01035 / +91 98600 98343"}
                  </p>
                </div>
                <div>
                  <Link
                    href={`tel:${settings?.contactDetails?.phone?.split('/')[0]?.trim()?.replace(/\s/g, "") || "+919075201035"}`}
                    className='text-primary text-base font-medium flex items-center gap-3 group hover:text-midnight_text dark:hover:text-white'>
                    Contact us
                    <svg
                      width='23'
          ...
          <div className='md:pt-32 pt-11 md:pb-28 pb-8'>
            <iframe
              src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.849240149482!2d73.78193730000001!3d19.9813934!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1sPAARSH+INFOTECH+PVT+LTD!2s19.9813934,73.7819373!5e0!3m2!1sen!2sin!4v1234567890'
              width='1114'
              height='477'
              loading='lazy'
              allowFullScreen
