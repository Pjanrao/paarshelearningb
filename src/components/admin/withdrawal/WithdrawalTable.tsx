                                            ...
                                            (w: any, index: number) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-4 py-3 text-center">
                                                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase ${w.paymentMethod === "UPI" ? "bg-orange-100 text-orange-700" :
                                                                w.paymentMethod === "Cash" ? "bg-green-100 text-green-700" :
                                                        ...
                                                        <div className="flex items-center justify-end gap-1">
                                                            ...
                                                            <div className="flex bg-gray-50 p-1 rounded-xl border border-gray-100">
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="p-2 text-indigo-600 hover:bg-white hover:shadow-sm rounded-lg transition-all border-l border-gray-100"
                                                                    title="Payment and Transaction Details"
                                                                >
                                                                    <Wallet size={16} />
                                                                </button>
                                                            </div>
                                                            ...
                                                            {/* Management Group */}
                                                            <div className="flex bg-gray-50 p-1 rounded-xl border border-gray-100 ml-1">
                                                                <button
                                                                    onClick={() => {
                                                                        setSelectedWithdrawal(w);
                                                                        setOpenEdit(true);
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="p-2 text-rose-600 hover:bg-white hover:shadow-sm rounded-lg transition-all border-l border-gray-100"
