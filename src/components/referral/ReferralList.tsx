...
import { useGetReferralListQuery } from "@/redux/api/referralApi";

export default function ReferralList() {
    const { data } = useGetReferralListQuery();
                        ...
                        <tbody>
                            {currentData.map((ref: any) => (
                                <tr key={ref._id} className="border-b hover:bg-gray-50 transition">
                                    ...
                                    <td>
                                        <span className={`px-2 py-1 rounded-full text-xs ${ref.status === "Completed"
