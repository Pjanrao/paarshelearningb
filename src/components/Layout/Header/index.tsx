...
const Header: React.FC = () => {
  ...
  <div className="absolute right-2 top-12 w-64 bg-white/95 backdrop-blur-md border border-gray-100 rounded-xl shadow-lg p-4 z-50">
    ...
    >
      ...
      <div
        ref={mobileMenuRef}
        className={`lg:hidden fixed top-0 right-0 h-full w-[300px] bg-white shadow-2xl transition-transform duration-300 ${navbarOpen ? 'translate-x-0' : 'translate-x-full'} z-50`}>
