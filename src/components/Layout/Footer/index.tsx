    ...
    <footer className="bg-darkmode border-t border-dark_border pt-10 pb-6 mt-0">
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-8 w-full">
          ...
          <div className="text-left w-full lg:max-w-md">
            ...
            <p className="md:w-[400px] w-full text-white/70 text-sm leading-relaxed text-left">
              Paarsh E-Learning is a leading edtech platform in Pune, Nashik, offering career-oriented courses in digital marketing and in-demand skills. Learn from industry experts through a secure and trusted online platform designed to help students build practical knowledge and achieve real career growth.
            </p>

          </div>

          <div className="text-left w-full flex lg:justify-center">
            <div className="w-full max-w-[320px]">
              <h3 className="text-white font-semibold mb-4 text-left">Quick Links</h3>
              <ul className="grid grid-cols-2 gap-x-8 gap-y-4 w-full text-white/70 text-sm font-medium">
                <li className="group">
                  <Link href="/#" className="flex items-center hover:text-secondary transition-all duration-300">
                    <span className="w-0 overflow-hidden group-hover:w-4 transition-all duration-300 text-secondary">
                      <ChevronRight className="w-3 h-3" />
                    </span>
                    <span className="transition-transform duration-300">Home</span>
                  </Link>
                </li>
                <li className="group">
                  <Link href="/Course" className="flex items-center hover:text-secondary transition-all duration-300">
                    <span className="w-0 overflow-hidden group-hover:w-4 transition-all duration-300 text-secondary">
                      <ChevronRight className="w-3 h-3" />
                    </span>
                    <span className="transition-transform duration-300">Courses</span>
                  </Link>
                </li>
                <li className="group">
                  <Link href="/about-us" className="flex items-center hover:text-secondary transition-all duration-300">
                    <span className="w-0 overflow-hidden group-hover:w-4 transition-all duration-300 text-secondary">
                      <ChevronRight className="w-3 h-3" />
                    </span>
                    <span className="transition-transform duration-300">About</span>
                  </Link>
                </li>
                <li className="group">
                  <Link href="/workshops" className="flex items-center hover:text-secondary transition-all duration-300">
                    <span className="w-0 overflow-hidden group-hover:w-4 transition-all duration-300 text-secondary">
                      <ChevronRight className="w-3 h-3" />
                    </span>
                    <span className="transition-transform duration-300">Workshops</span>
                  </Link>
                </li>
                <li className="group">
                  <Link href="/blog" className="flex items-center hover:text-secondary transition-all duration-300">
                    <span className="w-0 overflow-hidden group-hover:w-4 transition-all duration-300 text-secondary">
                      <ChevronRight className="w-3 h-3" />
                    </span>
                    <span className="transition-transform duration-300">Blogs</span>
                  </Link>
                </li>
                <li className="group">
                  <Link href="/careers" className="flex items-center hover:text-secondary transition-all duration-300">
                    <span className="w-0 overflow-hidden group-hover:w-4 transition-all duration-300 text-secondary">
                      <ChevronRight className="w-3 h-3" />
                    </span>
                    <span className="transition-transform duration-300">Careers</span>
                  </Link>
                </li>
                <li className="group">
                  <Link href="/inquiry" className="flex items-center hover:text-secondary transition-all duration-300">
                    <span className="w-0 overflow-hidden group-hover:w-4 transition-all duration-300 text-secondary">
                      <ChevronRight className="w-3 h-3" />
                    </span>
                    <span className="transition-transform duration-300">Inquiry</span>
                  </Link>
                </li>
                <li className="group">
                  <Link href="/contact-us" className="flex items-center hover:text-secondary transition-all duration-300">
                    <span className="w-0 overflow-hidden group-hover:w-4 transition-all duration-300 text-secondary">
                      <ChevronRight className="w-3 h-3" />
                    </span>
                    <span className="transition-transform duration-300">Contact</span>
                  </Link>
                </li>
              </ul>
            </div>
          ...
          <div className="text-left w-full flex lg:justify-end">
