...
function ApplyForm() {
    ...
    if (isSuccess) {
        return (
            <div className="text-center py-12 px-6">
                ...
                <Link
                    href="/careers"
                    className="inline-flex items-center text-sm font-semibold text-grey hover:text-primary mb-6 transition-colors group"
                >
    ...
    return (
        <div className="p-8 sm:p-10">
            <div className="mb-8">
                <h2 className="text-2xl font-semibold text-midnight_text mb-2">Submit Application</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-4">
                    <div>
                        <label htmlFor="name" className="block text-sm font-medium text-midnight_text mb-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label htmlFor="email" className="block text-sm font-medium text-midnight_text mb-1">
                        ...
                        <div>
                            <label htmlFor="phone" className="block text-sm font-medium text-midnight_text mb-1">
                    ...
                    <div>
                        <label htmlFor="resume" className="block text-sm font-medium text-midnight_text mb-1">
...
export default function Apply() {
    const router = useRouter();
    return (
        <div className="min-h-screen bg-section py-12 px-4 sm:px-6 flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="max-w-xl w-full z-10 relative">
                {/* BREADCRUMB */}
                <nav className="flex items-center gap-1.5 text-sm text-gray-500 mb-6 pl-2">
                    ...
                    <ChevronRight size={14} className="text-gray-400" />
                    <span className="text-[#2C4276] font-semibold">Apply</span>
                </nav>
