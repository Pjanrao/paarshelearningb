        ...
        const fetchData = async () => {
            try {
                ...
                if (profileRes.ok) {
                    ...
                    const teacher = data.teacher || data; // handle { teacher: ... } or { ... }
                    if (teacher) setProfile({
                        _id: teacher._id || "",
                        name: teacher.name || "",
                        email: teacher.email || "",
                        ...
                        assignedCourses: Array.isArray(teacher.assignedCourses) ? teacher.assignedCourses.join(", ") : (teacher.assignedCourses || ""),
                            ...
                            <CardContent className="p-6 sm:p-8">
                                <form onSubmit={handleProfileSubmit} className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-sm font-bold text-[#2C4276] dark:text-slate-300 ml-1">Expertise / Course Domain</Label>
                                            <Input
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-sm font-bold text-[#2C4276] dark:text-slate-300 ml-1">Experience</Label>
                                            <Input
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-sm font-bold text-[#2C4276] dark:text-slate-300 ml-1">Date of Joining</Label>
                                            <Input
                                                type="date"
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-sm font-bold text-[#2C4276] dark:text-slate-300 ml-1">Assigned Courses <span className="text-gray-500 text-xs font-normal">(Comma separated)</span></Label>
                                            <Input
                                                value={profile.assignedCourses}
                                                onChange={(e) => setProfile({ ...profile, assignedCourses: e.target.value })}
                                                className="h-12 rounded-xl bg-gray-50/50 dark:bg-slate-800/50 border-gray-200 dark:border-slate-700 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900 focus:border-[#3b82f6] transition-all dark:text-slate-100 font-medium"
                                                placeholder="e.g., React, Node.js"
                                            />
                                        </div>
                                        <div className="space-y-2">
                                            <Label className="text-sm font-bold text-[#2C4276] dark:text-slate-300 ml-1">Total Students</Label>
                                            <Input
                                                type="number"
                                                min="0"
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-sm font-bold text-[#2C4276] dark:text-slate-300 ml-1">Rating</Label>
                                            <Input
                                                type="number"
                                                step="0.1"
                                                min="0"
                            ...
                            <CardContent className="p-6 sm:p-8 space-y-8">
                                <form onSubmit={handleSecuritySubmit} className="space-y-6 max-w-2xl">
                                    ...
                                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
                                        <Link href="/forgot-password" target="_blank" className="text-sm font-medium text-[#c4b182] hover:text-[#2C4276] hover:underline dark:hover:text-blue-400 transition-colors">
