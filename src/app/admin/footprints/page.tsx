...
export default function TrackTimePage() {
    ...
    const fetchVisits = async () => {
        try {
            setLoading(true);
            const limit = groupsPerPage === "all" ? 10000 : groupsPerPage;
    ...
    }, [searchQuery, currentPage, groupsPerPage]);
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            {formatDateTime(group.lastActive)}
                                                        </div>
                                                    </td>
                        ...
                        <div className="px-6 py-4 border-t border-gray-100 bg-gray-50 flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div className="flex items-center gap-3">
                                <span className="text-sm text-gray-500 font-medium">
                                    Showing <span className="text-gray-900">{userGroups.length}</span> of <span className="text-gray-900">{total}</span> users
                                </span>
