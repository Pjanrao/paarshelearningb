...
const BlogCard = ({ blog }: BlogCardProps) => {
    return (
        <motion.div
            ...
            className="group bg-white border border-gray-100 rounded-[24px] overflow-hidden shadow-sm flex flex-col h-full"
        >
            <Link href={`/blog/${blog.id}`} className="flex flex-col h-full">
                ...
                <div className="p-6 flex flex-col flex-1">
                    <div className="flex items-center gap-3 mb-4 text-gray-500 text-xs font-bold uppercase tracking-wider">
                        <span className="flex items-center gap-1.5">{blog.date}</span>
